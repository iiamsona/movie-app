...
const MovieDescription = () => {
  ...
  return (
    <section
    className="relative h-6/7 w-full flex flex-col justify-center items-start bg-cover bg-center bg-no-repeat pl-44"
  ...
  >
    ...
    {/* Content container */}
    <div className="relative flex flex-col p-2 gap-3 w-4/10">
